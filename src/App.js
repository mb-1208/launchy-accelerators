...
function App() {
  ...
  async function save(e) {
    ...
    try {
      let data = {
        ...
        "utm_medium": "organic",
        "referring_site": "accelerators.launchy.app"
      }
      ...
      await axios.post(`https://launchy-server.rshme.codes/api/v1/user/subscribe`, data, {
        ...
        saveRegistrant(
          ...
          setTimeout(function () {
            ...
            window.location.replace('https://docs.google.com/spreadsheets/d/1W-J72tlizitdr2hwiFfyFa7nTzutkALjF0MVewkbVb4/edit?usp=sharing');
          }, 1000);
  ...
  return (
    <section className="py-12 bg-white sm:py-16 lg:py-20" style={{ paddingTop: '2rem' }}>
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <MediaQuery minWidth={768}>
          ...
          <div>
            <img className="w-2/12 mt-10 h-8 mx-auto h-auto" src="./assets/launchy.png" alt="" />
          </div>
        </MediaQuery>
        ...
        <div className="grid max-w-lg grid-cols-1 mx-auto mt-8 gap-y-12 lg:mt-24 lg:max-w-none lg:grid-cols-2">
          <div className="lg:px-12 xl:px-16">
            <div className="text-center">
              ...
              <p className="px-4 mt-5 text-lg font-normal text-gray-900 sm:px-0 font-pj">Fill out your email to receive the <span className="font-semibold">accelerators list</span>.</p>
            </div>
                ...
                <div className='btn-input-wrap block'>
                  <button className='btn-input-style focus:ring-core-900 focus:border-red-900 focus:outline-none' onClick={(e) => {
                    ...
                    {processCondition === 'Subs' &&
                      <span className="font-extrabold">View List</span>
                    }
